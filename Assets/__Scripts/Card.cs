...
public class Card : MonoBehaviour
{
    ...
    public CardDefinition def; // Parsed from DeckXML.xml'
                               // List of the SpriteRenderer Components of this GameObject and itschildren
public SpriteRenderer[] spriteRenderers;
    ...
    // Virtual methods can be overridden by subclass methods with the samename
...
[System.Serializable] // A Serializable class is able to be edited intheInspector
public class Decorator
{
    // This class stores information about each decorator or pip fromDeckXML
